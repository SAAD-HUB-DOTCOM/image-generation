...
from service.openai_service import generate_thumbnail
from service.imagekit_service import upload_file
...
STYLES = {
    ...
    "vibrant_energetic": (
        "Create a vibrant, energetic YouTube thumbnail with bold colors, "
        "dynamic composition, high energy feel, and eye-catching design. "
        "The person should look excited and engaging."
    ),
}
